...
range (as shown in ~\Autoref{fig:raycasting}). The code below shows the
...
the options enabled or chosen by the application code. These tags corresponds
to each setup in a ray casting shader: 1) Declaration of variables 2) Initialization
of ray position and direction 3) Iterative Ray traversal inside the volume and
check for ray termination conditions 4) Final color and opacity computation after
ray termination. For instance, the skeleton fragment shader defines tags as shown
...
\centering
  \begin{subfigure}[b]{.35\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{tooth_front_.png}
    \caption{Volume only.}
    \label{fig:tooth_front}
  \end{subfigure}
  \begin{subfigure}[b]{.35\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{tooth_front_enamel.png}
    \caption{Intermixed.}
    \label{fig:tooth_front_enamel}
  \end{subfigure}
  \begin{subfigure}[b]{.35\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{tooth_bottom_.png}
    \caption{Volume only \\(rotated).}
    \label{fig:tooth_bottom}
  \end{subfigure}
  \begin{subfigure}[b]{.35\columnwidth}
    \centering
    \includegraphics[width=\columnwidth]{tooth_bottom_enamel.png}
...
rendering parameters for that sample.  See ~\Autoref{fig:rendertotexture}for an example of label data
masks.

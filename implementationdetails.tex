...
code generation starts with a template vertex and fragment shader with
...
We have formalized these tag labels to correspond to each step
in the ray casting shader: 1) Declaration of variables 2) Initialization of ray

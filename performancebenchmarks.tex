...
The results of the benchmark are shown in~\Autoref{fig:perf-bench}. As observed,
...
\begin{figure}[ht]
  ...
  \begin{tikzpicture}
    ...
    %\begin{axis}[
      ...
      \addplot[color={rgb:red,228;green,26;blue,28},mark=10-pointed star] file {data/k5200.data};
      \label{plot_k52}
      \addlegendentry{NVIDIA Quadro K5200}
      \addplot[color={rgb:red,77;blue,175;green,74},mark=otimes] file {data/amdD300.data};
      \label{plot_a3}
      \addlegendentry{AMD FirePro D300}
      \addplot[color={rgb:red,101;blue,10;green,64},mark=star] file {data/geforce960M.data};
      \label{plot_gf96}
      \addlegendentry{NVIDIA GeForce 960M}
      \addplot[color={rgb:red,55;green,126;blue,184},mark=o] file {data/iris.data};
      \label{plot_iris}
      \addlegendentry{Intel Iris Graphics 550}
      \addplot[color={rgb:red,255;blue,255;green,51},mark=triangle*] file {data/quadro2000.data};
      \label{plot_q20}
      \addlegendentry{NVIDIA Quadro 2000}
      \addplot[color={rgb:red,152;blue,78;green,163},mark=diamond] file {data/intelhd530.data};
      \label{plot_i530}
      ...
      \addplot[color={rgb:red,228;green,26;blue,28},mark=10-pointed star] file {data/k5200_shaded.data};
      \label{plot_k52_s}
      \addlegendentry{NVIDIA Quadro K5200}
      \addplot[color={rgb:red,77;blue,175;green,74},mark=otimes] file {data/amdD300_shaded.data};
      \label{plot_a3_s}
      \addlegendentry{AMD FirePro D300}
      \addplot[color={rgb:red,101;blue,10;green,64},mark=star] file {data/geforce960M_shaded.data};
      \label{plot_gf96_s}
      \addlegendentry{NVIDIA GeForce 960M}
      \addplot[color={rgb:red,55;green,126;blue,184},mark=o] file {data/iris_shaded.data};
      \label{plot_iris_s}
      \addlegendentry{Intel Iris Graphics 550}
      \addplot[color={rgb:red,255;blue,255;green,51},mark=triangle*] file {data/quadro2000_shaded.data};
      \label{plot_q20_s}
      \addlegendentry{NVIDIA Quadro 2000}
      \addplot[color={rgb:red,152;blue,78;green,163},mark=diamond] file {data/intelhd530_shaded.data};
      \label{plot_i530_s}
      \addlegendentry{Intel Graphics HD 530}
    \end{groupplot}
    %legend

...
% * <nandini.seshadri@kitware.com> 2017-10-04T14:25:55.816Z:
% 
% > Phong
% 
% just checking that this is not a typo!!
% 
% ^.
...
MayaVi~\citep{ramachandran2011mayavi} all use VTK as the
underlying visualization library, and will benefit from our work.
ParaView has already been switched to use our work, and work on updating Slicer to use

...
from sample systems with different graphics cards ranging from on-board Intel
Graphics to dedicated GPUs. The code used to benchmark is located within the VTK
code repository under \texttt{Utilities/Benchmarks/}. The results of the
...
\begin{figure}[htbp]
  ...
  \begin{tikzpicture}
    ...
    \end{axis}
    %legend
    \node [draw,fill=white] at (rel axis cs: 0.8,0.9) {
      \shortstack[l]{
    ...
    \node [draw,fill=white] at (rel axis cs: 0.8,0.65) {
      \shortstack[l]{
